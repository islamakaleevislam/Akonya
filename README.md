...
<head>
    ...
    <title>История электричества</title>
    <style>
        body {
...
<body>
    ...
    <div id="page11" class="window">
        <section>
            ...
            <p><strong>Для дальнейшего изучения:</strong> Изучите роль солнечной и ветряной энергии в современном энергетическом ландшафте.</p>
        </section>
    </div>
